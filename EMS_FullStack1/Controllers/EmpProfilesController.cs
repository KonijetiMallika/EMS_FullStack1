...
namespace EMS_FullStack1.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class EmpProfilesController : ControllerBase
    {
        private readonly EMS_FullStack1DbContext _context;

        public EmpProfilesController(EMS_FullStack1DbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<EmpProfile>> PostEmpProfile(EmpProfile empProfile)
        {
          if (_context.EmpProfile == null)
          {
              return Problem("Entity set 'EMS_FullStack1DbContext.EmpProfile'  is null.");
          }
